...
export default function PolicyStudioContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 bg-gradient-to-r from-danger/10 via-warning/10 to-primary/10 border border-danger/20 rounded-xl">
