...
import { Activity, Shield, Users, Clock, CheckCircle2, AlertTriangle, Database } from "lucide-react";
...
export function RealityCheckDashboard() {
  ...
  const hasData = metrics && (
    ...
    metrics.governanceBlocks > 0 || 
    metrics.hitlReviews > 0
  );
        ...
        {!hasData && (
          <div className="mb-4 p-3 bg-yellow-500/10 border border-yellow-500/30 rounded-lg flex items-center gap-2">
            ...
            <span className="text-sm text-yellow-500">
              No production traffic yet — connect your model and send requests to see data
            </span>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          <div className="p-4 bg-background/50 rounded-lg border border-border">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-muted-foreground">Processed Requests</span>
            </div>
          ...
          <div className="p-4 bg-background/50 rounded-lg border border-border">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-muted-foreground">Governance Blocks</span>
            </div>
            <p className="text-2xl font-bold text-foreground">
              {metrics?.governanceBlocks || 0}
            </p>
          ...
          <div className="p-4 bg-emerald-500/10 rounded-lg border border-emerald-500/30">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-emerald-500">Data Quality</span>
            </div>
            <p className="text-2xl font-bold text-emerald-500">
              100%
            </p>
            <p className="text-xs text-emerald-500/70">No Legacy Data</p>
          </div>
        </div>
      </CardContent>
    </Card>
