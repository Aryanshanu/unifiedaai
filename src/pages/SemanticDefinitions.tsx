...
import { useSemanticDefinitions, useCreateDefinition, useUpdateDefinition, useDeleteDefinition } from '@/hooks/useSemanticDefinitions';
        ...
        <div className="space-y-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <Input
                placeholder="Search definitions by name, synonym..."
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                className="pl-10 h-11 bg-card border-border"
              />
            </div>
            <Button className="h-11 bg-gradient-primary text-primary-foreground" onClick={() => setCreating(true)}>
